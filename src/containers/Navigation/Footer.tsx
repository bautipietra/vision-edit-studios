...
export default function Footer() {
  return (
    <footer className='bg-purple-900/20'>
      <div className='mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8'>
        ...
        <div className='mt-12 text-white text-center flex gap-8 justify-center items-center'>
          <Link
            className='hover:bg-white/10 p-4 rounded-full transition-colors flex items-center justify-center'
            href={
